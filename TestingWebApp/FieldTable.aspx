<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FieldTable.aspx.cs" Inherits="saral.FieldTable" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:HiddenField runat="server" ID="fid" Value="0" />
                     ...
                     CellPadding="3" Height="153px" OnSelectedIndexChanged="FieldGridView_SelectedIndexChanged" 
                    ...
                    <SortedDescendingHeaderStyle BackColor="#00547E" />
                     ...
                     <Columns>
                         ...
                         <asp:TemplateField HeaderText="Field Name" >
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="FooterFieldNametxt"  runat="server"></asp:TextBox>
                                </FooterTemplate>
                         ...
                         <asp:TemplateField HeaderText="Type" >
                                <ItemTemplate>  
                                    <asp:Label ID="Label2" Text='<%# Bind("FieldType") %>' runat="server"/>
                                </ItemTemplate>
                                
                                 <EditItemTemplate>  
                                <asp:TextBox ID="Typetxt" Text='<%# Bind("FieldType") %>' runat="server"></asp:TextBox>  
                                </EditItemTemplate>  
                         ...
                         <asp:TemplateField HeaderText="Order" >
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="FooterOrderTxt"  runat="server"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                          <%----------------------------------------------------------------------------------------------%>
